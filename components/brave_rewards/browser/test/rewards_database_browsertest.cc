...
class RewardsDatabaseBrowserTest
 ...
 public:
  ...
  ~RewardsDatabaseBrowserTest() override = default;
    ...
    Migration_18_CredsBatch) {
  {
    ...
    while (sql.Step()) {
      ...
      creds_database.trigger_type =
          static_cast<ledger::CredsBatchType>(sql.ColumnInt(2));
    ...
    creds_expected.trigger_type = ledger::CredsBatchType::PROMOTION;

...
void RewardsBrowserTestContribution::AddExternalBalance(const double balance) {
...
void RewardsBrowserTestContribution::AddPendingBalance(const double balance) {
  pending_balance_ += balance;
}

double RewardsBrowserTestContribution::GetPendingBalance() {
...
std::string RewardsBrowserTestContribution::GetStringBalance() {
  std::string balance = rewards_browsertest_util::BalanceDoubleToString(
...
ledger::Result RewardsBrowserTestContribution::GetMultipleTipStatus() {
